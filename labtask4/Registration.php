...
<?php include 'menu.php';?>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	  ...
	  Voter Id No: <input type="text" name="voterid" value="<?php echo $password;?>">
	  ...
	  Address: <input type="text" name="address" value="<?php echo $password;?>">
	  <span class="error">* <?php echo $passwordErr;?></span>
	  <br><br>
	...
	<br>
	  ...
	  <input type="reset" name="" value="Exit">
	  <br>
	  </fieldset>
